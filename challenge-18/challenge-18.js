(function() {
  ...
  */
  ...
  let reHTMl2 = /<\w+><\/\w+>/g;
  let html2 = "<div><ul><li></li><li></li><li><span></span></li></ul></div>";

  console.log(html2.match(reHTMl2));
  ...
  */
  ...
  let text = `<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>`;
  let re = /<(\w+)>([^<]+)<\/\w+>/g;
