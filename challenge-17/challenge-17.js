(function() {
  ...
  */
  ...
  let regex = /Manuel Marques de Sousa/g;
  let myName = 'Lucas Morais dos Santos';

  console.log(text.replace(regex, myName));
  ...
  */
  ...
  let regex2 = /brasileiro/g;
  let nationality = 'paulista';

  console.log(text.replace(regex2, nationality));
  ...
  */
  ...
  console.log(text.replace(regex3, trace));
  ...
  */
  ...
  console.log(text.replace(regex4, zero));
  ...
  */
  ...
  console.log(text.replace(regex5, four));
  ...
  */
  ...
  let regex6 = /O Centauro de Luvas/g;

  let phraseUpperCase = text.replace(regex6, (phrase) => {
  ...
  */
  ...
  let regexDate = /([0-9]{2}) de (junho|julho) de ([0-9]{4})/g;
